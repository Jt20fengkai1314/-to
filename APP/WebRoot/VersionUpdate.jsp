              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath }/Version/VersionUpdate/${appV.id}" method="post">
							<span class="section">新增APP版本信息</span>

	                      <div class="item form-group">
	                         <label class="control-label col-md-3 col-sm-3 col-xs-12" >版本号 ：</label> 
	                         <input  class="control-label col-md-3 col-sm-3 col-xs-12" value="${appV.versionNo }"  required name="versionNo"   type="text"/>
	                      </div>
	                     <div class="item form-group">
	                         <label class="control-label col-md-3 col-sm-3 col-xs-12" >版本大小 ：</label> 
	                         <input  class="control-label col-md-3 col-sm-3 col-xs-12" value="${appV.versionSize }" required   name="versionSize"   type="text"/>
	                      </div>
	                   <div class="item form-group">
	                         <label class="control-label col-md-3 col-sm-3 col-xs-12" >发布状态：</label> 
	                         <input  class="control-label col-md-3 col-sm-3 col-xs-12" value="${appV.publishStatus==1?'不发布':appV.publishStatus==2?'已发布':'预发布'}" disabled name="publishStatus"   type="text"/>
	                      </div>
	                    <div class="item form-group">
                         <label class="control-label col-md-3 col-sm-3 col-xs-12">版本简介 ：</label> 
                         <input  class="control-label col-md-3 col-sm-3 col-xs-12" value="${appV.versionInfo}"  required name="versionInfo"   type="text"/>
                       </div>
                       <div class="item form-group">
                         <label class="control-label col-md-3 col-sm-3 col-xs-12">apk文件 ：</label> 
                         <input  class="control-label col-md-3 col-sm-3 col-xs-12" value="${appV.apkFileName }"   disabled name="apkLocPath"   type="file"/>
                      </div>
