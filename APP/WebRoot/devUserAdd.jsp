              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="post" action="${pageContext.request.contextPath }/appInfo/Add" enctype="multipart/form-data">
	                     ...
	                     <div class="item form-group">
	                         ...
	                         <input  class="control-label col-md-3 col-sm-3 col-xs-12" value="${ai.APKName}" required  name="APKName"   type="text"/>
	                      </div>
	                   <div class="item form-group">
                      ...
                      <div class="item form-group">
                         <label class="control-label col-md-3 col-sm-3 col-xs-12">所属平台 ：</label>
                       									 <select name="flatformId"  class="control-label col-md-3 col-sm-3 col-xs-12" >
                      ...
                      <div class="item form-group">
                         <label class="control-label col-md-3 col-sm-3 col-xs-12" >APP状态 ：</label>
                        								<select name="status"  class="control-label col-md-3 col-sm-3 col-xs-12" >
																<option value="0">--请选择--</option>
																<c:forEach items="${ddt}" var="d">
																	<option value="${d.valueId }">${d.valueName}</option>
																</c:forEach>
														</select>
                      </div>
                      <div class="item form-group">
                         ...
                         <input  class="control-label col-md-3 col-sm-3 col-xs-12"  required  name="appInfo"   type="text"/>
                      </div>
                     <div class="item form-group">
                         <label class="control-label col-md-3 col-sm-3 col-xs-12" >LOGO图片：</label> 
                         <input  class="control-label col-md-3 col-sm-3 col-xs-12"   name="pic"   type="file"/>
                      </div> 
